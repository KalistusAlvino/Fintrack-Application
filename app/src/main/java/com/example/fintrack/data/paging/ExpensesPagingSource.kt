...
class ExpensesPagingSource(private val transactionRemoteDataSource: TransactionRemoteDataSource
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, GetTransactionResponse> {
        return try {
            ...
            val transaction = transactionRemoteDataSource.getAllExpenses(pageNumber = currentPage)
            LoadResult.Page(
